...
export const Sheets = () => {
  ...
  const isSelected = (row: number, col: number) => {
    ...
    const select = row >= r1 && row <= r2 && col >= c1 && col <= c2;
                  ...
                  (_, index2) => {
                    ...
                    return (
                      <td
                        ...
                        className="m-0 p-0 border border-slate-300 text-sm text-black relative"
                      >
                        {index2 > 0 ? (
                          <>
                          ...
                          : "transparent",
                            ...
                            <input
                              ...
                              className="relative z-0 w-full h-full border-0 outline-none focus:ring-1 ring-blue-500"
                            />
                          </>
                        ) : (
                          <div
